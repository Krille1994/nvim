...
vim.keymap.set("t", "<Esc><Esc>", function()
	vim.api.nvim_chan_send(vim.b.terminal_job_id, "\003") -- ASCII 3 = Ctrl-C
end, { noremap = true, desc = "Send real Ctrl-C to terminal" })

vim.keymap.set("n", "<Esc><Esc>", function()
	if vim.bo.buftype == "terminal" and vim.b.terminal_job_id then
		vim.api.nvim_chan_send(vim.b.terminal_job_id, "\003")
	end
end, { noremap = true, desc = "Send real Ctrl-C from normal mode terminal" })
local state = {
